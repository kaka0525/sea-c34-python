...
There can be any number of positional and optional arguments. However, keyword args
should follow after non-keyword ones.
"""
...
print(u'Hello, my name is {name}, I am {age} years old, and my grade is {grade}.'.format(**mydict))